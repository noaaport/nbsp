...
`    * Return a string representation of this object.
    ...
    /**
     * helper function  to convert from binary to hex representation
     */

    private void hexDigit(StringBuffer s, byte x) {
	char c;
	...
	MD5 digest = new MD5();
	digest.init();
	digest.updateASCII(args[0]);
	digest.finish();
	System.out.println(args[0] + ": " + digest);
    }
}
