...
txt.$rc(station), [subst $rstnntpfilter(txt_subject_station)])
...
emwin.urgent.$rc(station), [subst $rstnntpfilter(txt_subject_station)])
match_txt_only($rc(body), URGENT,
emwin.urgent, [subst $rstnntpfilter(txt_subject_urgent)])
...
emwin.urgent.$rc(station), [subst $rstnntpfilter(txt_subject_station)])
match_txt_only($rc(body), EAS ACTIVATION,
emwin.urgent, [subst $rstnntpfilter(txt_subject_eas)])
...
emwin.warnings.$rc(station), [subst $rstnntpfilter(txt_subject_station)])

match_txt_only_except($rc(wmoid), ^a, $rc(awips), ^$,
emwin.summary.$rc(station), [subst $rstnntpfilter(txt_subject_station)])

match_txt_only_except($rc(wmoid), ^f, $rc(awips), ^$,
emwin.forecast.$rc(station), [subst $rstnntpfilter(txt_subject_station)])

match_txt_only_except($rc(wmoid), ^[crstu], $rc(awips), ^$,
emwin.data.$rc(station), [subst $rstnntpfilter(txt_subject_station)])
...
misc.adm, [subst $rstnntpfilter(txt_subject_adm)])
match_txt_only($rc(fname), (kwno|kwbc|kncf)_nous[4678], misc.adm,
[subst $rstnntpfilter(txt_subject_adm)])
