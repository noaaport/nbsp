...
# is the netcdf file (e.g., tire05paf_20250116_1256.goesr)
#
# In the simple case:
#   nbspgoesrmap tire05paf_20250116_1256.goesr (output to stdout)
#   nbspgoesrmap -n tire05paf_20250116_1256.goesr
#     (output to tire05paf_20250116_1256.png
#   nbspgoesrmap -o t.png  tire05paf_20250116_1256.goesr (output to t.png)
#
# -b => background
...
# In the simplest use,
#
#   nbspgoesrmap <ncfile>  (e.g. tire05paf_20250116_1256.goesr)
#
