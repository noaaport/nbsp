...
match_file($rc(fname), knhc_(wtnt|wtpz)3[1-5],
nwx/nhc/public, $ymdh.pblc)
...
match_file($rc(fname), knhc_(wtnt7[1-5]|wtpz7[1-5]),
nwx/nhc/probs, $ymdh.probs)
...
matchstop_file($rc(awips1), 
cfw|cwf|glf|gls|hsf|ice|iob|lsh|maw|mim|mrp|mvf|mws|nsh|ocd|off|omr|osw|pls|smw|srf|tid, 
...
match_file($rc(awips1), wsw|ffw|flw, nwx/watch_warn/$rc(AWIPS1),
$ymdh.$rc(AWIPS1))
