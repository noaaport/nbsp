...
/*
 * Same as wr except using a cache-only db (to be used with rc1)
 *
 ...
 * ./wr in/*
 *
 * The files will be stored in the spoolbdb; see rc1 to read and writte the
...
int main(int argc, char **argv){
  ...
  if(status == 0){
    ...
    fprintf(stdout, "Waiting 15 seconds.\n");
    fflush(stdout);
    sleep(15);
  }
