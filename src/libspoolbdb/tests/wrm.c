...
/*
 * Same as wr except using an in-memory db.
 *
...
int main(int argc, char **argv){
  ...
  int dbfile_mode = 0;   /* in-memory */
  int dbenv_mode = 0;   /* in-memory */
  char *dbhome = NULL;	/* in-memory */
  char *dbfname = NULL; /* in-memory */
  int f_mpool_nofile = 0; /* not used */
  char **files;
